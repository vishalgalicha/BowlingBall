...
namespace BowlingBall.Tests
{
    ...
    public class GameFixture
    {
        ...
        {
            var game = new GameRoll(new GameScore());
            ...
            Roll(game,Frame);
            Assert.AreEqual(0, game._gameScore.GetScore());
        }
        [TestMethod]
        public void Gutter_game_score_should_not_be_zero_test()
        {
            ...
            Roll(game,Frame);
            Assert.AreNotEqual(0, game._gameScore.GetScore());
        }        
        [TestMethod]
        public void Gutter_game_score()
        {
            ...
            Roll(game,Frame);
            Assert.AreEqual(178, game._gameScore.GetScore());
        }
        [TestMethod]
        ...
        [TestMethod]
        public void Gutter_game_score2_should_be_zero_test()
        {
            var game = new GameRoll(new GameScore());
            int[][] Frame = new int[10][];
            Frame[0] = new int[2] { 10, 0 };  //20
        ...
        [TestMethod]
        public void Gutter_game_score2()
        {
            var game = new GameRoll(new GameScore());
            int[][] Frame = new int[10][];
            Frame[0] = new int[2] { 10, 0 };  //20
            ...
            Roll(game, Frame);
            Assert.AreEqual(187, game._gameScore.GetScore());
        }


        private void Roll(GameRoll game, int[][] frame)
        {
            game.Roll(frame);
        }
    }
